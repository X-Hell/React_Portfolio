...
const Data = () => {
    return (
       <div className="home__data">
        <h1 className="home__title">Manish Shaw
        ...
        <p className="home__description">Hey there, I'm Manish, a developer based in India, and I am very passionate and dedicated to my work.</p>
